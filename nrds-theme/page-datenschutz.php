...
<main class="legal-wrap">
  ...
  <section class="legal-section">
    ...
    <p>Die Verwendung von IONOS erfolgt auf Grundlage von Art. 6 Abs. 1 S. 1 lit. f) DSGVO. Wir haben ein berechtigtes Interesse an einer möglichst zuverlässigen Darstellung unserer Website.</p>
  </section>
  ...
  <section class="legal-section">
    <h2><span class="num">09</span> Online-Bewerbung</h2>
    <p>Die von Ihnen übermittelten personenbezogenen Daten werden zum Zweck der Entscheidung über die Begründung eines Beschäftigungsverhältnisses gemäß Art. 6 Abs. 1 S. 1 lit. b) DSGVO erhoben, verarbeitet und genutzt. Eine Weitergabe Ihrer personenbezogenen Daten an externe Dritte erfolgt nicht.</p>
    <p>Ihre Bewerbungsunterlagen werden bei uns für die Dauer des Bewerberverfahrens gespeichert und darüber hinaus für 3 Monate aufbewahrt.</p>
  </section>

  <section class="legal-section">
    <h2><span class="num">10</span> Cookies</h2>
    <p>Unsere Webseite benutzt keine Cookies.</p>
  </section>

  <section class="legal-section">
    <h2><span class="num">11</span> Webkonferenz-Tools</h2>
    <p>Wir nutzen Konferenz-Tools für Video- und Audio-Konferenzen, um die Kommunikation mit Interessenten, Kunden und Nutzern zu vereinfachen. Rechtsgrundlage ist unser berechtigtes Interesse gemäß Art. 6 Abs. 1 S. 1 lit. f) DSGVO.</p>
  </section>

  <section class="legal-section">
    <h2><span class="num">12</span> Microsoft Teams</h2>
    <p>Wir nutzen das Webkonferenz-Tool Microsoft Teams, eine Anwendung der Microsoft Corporation (One Microsoft Way, Redmond, WA 98052-6399, USA). Die Datenschutzerklärung von Microsoft finden Sie unter: <a href="https://privacy.microsoft.com/de-de/privacystatement" target="_blank" rel="noopener noreferrer">privacy.microsoft.com/de-de/privacystatement</a></p>
    <p>Das Unternehmen verfügt über eine Zertifizierung nach dem „EU-US Data Privacy Framework" (DPF).</p>
  </section>

  <section class="legal-section">
    <h2><span class="num">13</span> Unternehmensauftritt auf LinkedIn</h2>
    <p>Wir nutzen unseren Unternehmensauftritt auf LinkedIn zur Kommunikation und zum Informationsaustausch mit (potenziellen) Kunden. Unser LinkedIn-Unternehmensauftritt wird von der LinkedIn Ireland Unlimited Company, Dublin, Irland, bereitgestellt.</p>
    <p>Weitere Informationen finden Sie in der Datenschutzerklärung von LinkedIn: <a href="https://de.linkedin.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">de.linkedin.com/legal/privacy-policy</a></p>
  </section>

  <section class="legal-section">
    <h2><span class="num">14</span> Ihre Rechte und Geltendmachung von Rechten</h2>
    <p>Ihnen stehen die unten genannten Rechte zu. Zur Geltendmachung kontaktieren Sie uns per E-Mail an: <a href="mailto:datenschutz@norisk-datasecurity.com">datenschutz@norisk-datasecurity.com</a>.</p>
    <h3>Auskunft</h3>
    <p>Sie haben gemäß Art. 15 DSGVO das Recht, Auskunft über Ihre von uns verarbeiteten personenbezogenen Daten zu verlangen.</p>
    <h3>Berichtigung</h3>
    <p>Sie haben gemäß Art. 16 DSGVO das Recht, unverzüglich die Berichtigung unrichtiger oder die Vervollständigung Ihrer bei uns gespeicherten personenbezogenen Daten zu verlangen.</p>
    <h3>Löschung</h3>
    <p>Sie haben gemäß Art. 17 DSGVO das Recht, die Löschung Ihrer bei uns gespeicherten personenbezogenen Daten zu verlangen.</p>
    <h3>Einschränkung der Verarbeitung</h3>
    <p>Sie haben gemäß Art. 18 DSGVO das Recht, die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen, soweit die gesetzlichen Voraussetzungen vorliegen.</p>
    <h3>Datenübertragbarkeit</h3>
    <p>Sie haben gemäß Art. 20 DSGVO das Recht, Ihre personenbezogenen Daten in einem strukturierten, gängigen und maschinenlesbaren Format zu erhalten.</p>
    <h3>Widerruf Ihrer Einwilligung</h3>
    <p>Sie haben gemäß Art. 7 Abs. 3 DSGVO das Recht, Ihre einmal erteilte Einwilligung jederzeit uns gegenüber zu widerrufen. Bitte richten Sie Ihren Widerruf an: <a href="mailto:datenschutz@norisk-datasecurity.com">datenschutz@norisk-datasecurity.com</a></p>
  </section>

  <section class="legal-section">
    <h2><span class="num">15</span> Widerspruchsrecht</h2>
    <p><strong>Sie haben das Recht, aus Gründen, die sich aus Ihrer besonderen Situation ergeben, jederzeit gegen die Verarbeitung der Sie betreffenden personenbezogenen Daten, die aufgrund von Art. 6 Abs. 1 S. 1 lit. e) oder f) DSGVO erfolgt, Widerspruch einzulegen.</strong></p>
    <p>Der Verantwortliche verarbeitet die Sie betreffenden personenbezogenen Daten dann nicht mehr, es sei denn, er kann zwingende schutzwürdige Gründe für die Verarbeitung nachweisen.</p>
  </section>

  <section class="legal-section">
    <h2><span class="num">16</span> Automatisierte Entscheidung im Einzelfall einschließlich Profiling</h2>
  ...
  <section class="legal-section">
    <h2><span class="num">17</span> Beschwerde bei einer Aufsichtsbehörde</h2>
